...
ALTER TABLE "customer" ADD FOREIGN KEY ("customer_id") REFERENCES "customer_permission" ("customer_id");

ALTER TABLE "customer_permission" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("company_id");

ALTER TABLE "user" ADD FOREIGN KEY ("user_id") REFERENCES "customer_permission" ("user_id");
